...
class Program
{
    static void Main(string[] args)
    {
        ...
        book1.SetBookInfo("Сила воли", "Мангонигал");
        book1.SetPublicationInfo(new DateTime(2022, 5, 23), 304);

        book2.SetBookInfo("Жизнь и смерть", "Майер");
        book2.SetPublicationInfo(new DateTime(2020, 5, 13), 800);
